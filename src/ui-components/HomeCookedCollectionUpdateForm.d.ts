...
export declare type HomeCookedCollectionUpdateFormInputValues = {
    CreatedTime?: string;
    CreatedDate?: string;
    Total?: number;
    DrinkItems?: string[];
...
export declare type HomeCookedCollectionUpdateFormOverridesProps = {
    HomeCookedCollectionUpdateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type HomeCookedCollectionUpdateFormProps = React.PropsWithChildren<{
    ...
    id?: string;
    homeCookedCollection?: HomeCookedCollection;
    onSubmit?: (fields: HomeCookedCollectionUpdateFormInputValues) => HomeCookedCollectionUpdateFormInputValues;
    onSuccess?: (fields: HomeCookedCollectionUpdateFormInputValues) => void;
    onError?: (fields: HomeCookedCollectionUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: HomeCookedCollectionUpdateFormInputValues) => HomeCookedCollectionUpdateFormInputValues;
    onValidate?: HomeCookedCollectionUpdateFormValidationValues;
} & React.CSSProperties>;
export default function HomeCookedCollectionUpdateForm(props: HomeCookedCollectionUpdateFormProps): React.ReactElement;
