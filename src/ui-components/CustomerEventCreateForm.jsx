...
export default function CustomerEventCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new CustomerEvent(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "CustomerEventCreateForm")}
      {...rest}
    >
      <TextField
        label="Event name"
