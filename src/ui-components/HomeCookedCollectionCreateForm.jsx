...
export default function HomeCookedCollectionCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setCollectionTime(initialValues.CollectionTime);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new HomeCookedCollection(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "HomeCookedCollectionCreateForm")}
      {...rest}
    >
      <TextField
        label="Created time"
