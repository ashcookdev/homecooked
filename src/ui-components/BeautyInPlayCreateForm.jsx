...
export default function BeautyInPlayCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new BeautyInPlay(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "BeautyInPlayCreateForm")}
      {...rest}
    >
      <TextField
